...
module.exports = {
    query:function(req,res){
        ...
        pool.getConnection(function(err,connection){
            ...
            connection.query(detailmodel.querybycom,[companyId,weekDay],function(err,result){
    ...
    queryAll:function(req,res){
        pool.getConnection(function(err,connection){
            ...
            connection.query(detailmodel.queryAll,[weekDay],function(err,result){
    ...
    queryByDepart:function(req,res){
        pool.getConnection(function(err,connection){
            ...
            connection.query(detailmodel.queryByDepartment,[id],function(err,result){
